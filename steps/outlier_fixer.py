...
class OutlierMasker(BaseEstimator, TransformerMixin):
    """
...
class LinearInterpolatorMasker(BaseEstimator, TransformerMixin):
    """
...
class PolynomialInterpolatorMasker(BaseEstimator, TransformerMixin):
    """
